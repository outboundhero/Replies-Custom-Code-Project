const VALID_CATEGORIES = [
  ...
  // Split-out automated/redirect look-alikes (spec §20). AI SUGGESTIONS only —
  // the reply stays in Open Response for review. ("Request for Primary Point of
  // Contact" is a MANUAL category, not an AI one — the team marks it to load the
  // send-reply template.)
