 ...
 * Uses GPT's geographic knowledge instead of geocoding APIs.
 */
...
const SYSTEM_PROMPT = `You are a geographic proximity assistant. Given a lead's location and a client's service area (which may include zip codes, city names, county names, or state names), determine if the lead is located within approximately 5 miles of the client's service area.
