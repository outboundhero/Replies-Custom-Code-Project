...
const companyCodes: Array<{ code: string; pattern: string }> = [
  ...
  { code: "BBS",   pattern: "blumontservices\\.com" },
  ...
  { code: "IM",    pattern: "imc\\.cleaning|\\bimc\\b" },
  { code: "ACAD",  pattern: "allcareallday" },
  { code: "CI",    pattern: "cappstone" },
  { code: "BCSA",  pattern: "broomday\\.com" },
  ...
  // Jan-Pro paths — all path-specific entries grouped together, most specific first
  ...
  { code: "PC",    pattern: "prioritycleaningllc\\.com" },
  ...
  // DBS variants — DBSM first (highest priority), then sub-brands sharing same domain
  ...
  { code: "SH",    pattern: "scrubheroesarizona\\.com|scrubheroes-az\\.com" },
  { code: "VGM",   pattern: "vanguardcleaningminn\\.com" },
  { code: "RTWJ",  pattern: "rtwjanitorial\\.com" },
  { code: "K&LCS", pattern: "knlcleaning\\.com" },
