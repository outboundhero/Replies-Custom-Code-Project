...
export async function POST(req: NextRequest) {
  try {
    ...
    console.error("[api/config/clients] POST failed:", error);
...
export async function PUT(req: NextRequest) {
  try {
    ...
    console.error("[api/config/clients] PUT failed:", error);
    return NextResponse.json({ error: "Failed to update client config" }, { status: 500 });
  }
}
...
export async function DELETE(req: NextRequest) {
  try {
    ...
    console.error("[api/config/clients] DELETE failed:", error);
